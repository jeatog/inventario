...
import { StyleSheet, Text, View, Button, ScrollView, Dimensions, TextInput, TouchableOpacity } from 'react-native';
...
export default function Categoria_elegida( {route} ){
  ...
  //const filtrados = datos.almacen_a.filter(elemento => elemento.categoria === tipo_cat);
    ...
    <View>
      <ScrollView style = { {backgroundColor: '#fff'} }>
        <View style={styles.container}>
          ...
          <Text style={styles.bodyText}> Estás ordenando la categoría de "{tipo_cat}".</Text>
        </View>
